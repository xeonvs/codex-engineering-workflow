...
| REQ-005 | Source patch release and exact marketplace import/release are published, with tgrep-search unchanged. | User-approved plan; marketplace release contract | WQ-03,WQ-04 | PR/CI readback, annotated tags, provenance, release assets | done |
| REQ-006 | Codex/Claude local managed installations resolve the released workflow version; plans close truthfully. | User-approved plan; prior installation preference | WQ-05 | Native CLI readback and lifecycle check/closure | done |
...
- [x] WQ-03 — Publish source PR, annotated patch tag and release for REQ-005. `done`
- [x] WQ-04 — Import into xeonvs-engineering, validate, PR/merge, tag and release for REQ-005. `done`
- [x] WQ-05 — Refresh installations, reconcile, and close both plans for REQ-006. `done`
...
- 2026-09-23: Source PR #17 passed CI and merged at `e73c8af994350ae0e463ab8856dff12b761f12ee`; annotated v0.9.9 and public GitHub release published, with tag CI green. Marketplace synchronizer imported exact v0.9.9 bytes and recorded provenance; tgrep-search 1.0.3 remains unchanged. Marketplace publication is still in progress.
- 2026-09-23: Marketplace PR #21 passed CI and merged at `914e75ef682f1cc5128454d05970136df7c073c3`; annotated v1.0.9 release workflow passed. Public archive and SHA256SUMS were downloaded and verified together; archive SHA-256 is `c957d4ffd89c6447a138399592315606d8ad4d0aa74affa19dad2e7db626e1df`. Codex and Claude native readback show engineering-workflow 0.9.9 and tgrep-search 1.0.3 enabled. Claude requests restart for already-running sessions. Issue #8 is closed by PR #17.
...
- None; publication and local refresh completed. Restart Claude to activate updated bytes in already-running sessions.
...
- [x] Final code, package, releases, installations, and plan states agree.

### Closure Gate

- [x] All requirements and queue items are terminal with final review and validation evidence.

### Post-Close Delivery

- Publication and local refresh completed before closure.
