    ...
    def test_check_detects_packaged_skill_byte_drift(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.multiple(
                ...
                builder._build_expected(expected, "0.8.0")
                builder.write_package(expected)
                comparison = root / "comparison"
                builder._build_expected(comparison, "0.8.0")
    ...
    def test_catalog_failure_restores_previous_package_and_catalogs(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with mock.patch.multiple(
                ...
                builder._build_expected(initial, "0.8.0")
                ...
                builder._build_expected(replacement, "0.8.0")
